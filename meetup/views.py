...
def home1(request):
    return render(request,'meetup/home1.html')
def home2(request):
    return render(request,'meetup/home2.html')
def home3(request):
    return render(request,'meetup/home3.html')


def index(request):
    return render(request,'meetup/about.html')
@csrf_protect
def signup(request):
...
def login(request):
    if request.method=='POST':
         ...
         if user is not None:
             ...
             return render(request,"meetup/dashboard.html ",context)
         else:
...
def room(request, room):
    ...
    return render(request, 'meetup/room.html', {
            'username': username,
            'room': room,
